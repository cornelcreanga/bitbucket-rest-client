...
import static com.cc.bitbucket.rest.client.http.responseparsers.Parsers.errorParser;
import static com.cc.bitbucket.rest.client.http.responseparsers.Parsers.listParser;


public class ErrorsParser implements Function<JsonElement, List<BitBucketError>> {
    @Override
    public List<BitBucketError> apply(JsonElement input) {
